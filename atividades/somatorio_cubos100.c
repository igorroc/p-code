...
int main(){
  // Instructions:
    ...
    code[_i].f = LOD; code[_i].l = 0; code[_i].a = 3; _i++;			// Prepara cubo (load aux)
    code[_i].f = OPR; code[_i].l = 0; code[_i].a = 4; _i++;			// Aux*Aux
    code[_i].f = OPR; code[_i].l = 0; code[_i].a = 4; _i++;			// Aux*Aux*Aux
    ...
    code[_i].f = JPC; code[_i].l = 0; code[_i].a = 23; _i++;		// Saida do loop
    code[_i].f = LOD; code[_i].l = 0; code[_i].a = 3; _i++;			// Load aux
